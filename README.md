...
* Папки (layouts, pages, widgets, components, ui) мають однонаправлену залежність - кожен рівень може імпортувати лише нижчі рівні, але не вище.
...
* Компоненти (`components/featureA`) **не може** імпортувати (`components/featureB`) компонент, на одному рівні імпорти можливі між компонентами.
